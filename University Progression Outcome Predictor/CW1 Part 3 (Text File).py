...
with open('text.txt', 'w') as file:
    for elements in progress:
        file.write('Progress - ' + str(elements).replace('[', '').replace(']', '') + '\n')
    for elements in trailer:
        file.write('Progress (module trailer) - ' + str(elements).replace('[', '').replace(']', '') + '\n')
    for elements in excluded:
        file.write('Excluded - ' + str(elements).replace('[', '').replace(']', '') + '\n')
    for elements in retriever:
        file.write('Module Retriever - ' + str(elements).replace('[', '').replace(']', '') + '\n')
